...
def upgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.create_table('tn_router_dbs',
        sa.Column('id', mysql.VARCHAR(display_width=32), nullable=False,
                  autoincrement=True),
        sa.Column('tenant_id', mysql.VARCHAR(length=32), nullable=False),
